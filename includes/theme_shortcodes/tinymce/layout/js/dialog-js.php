...
var tb_dialog_helper = {
    ...
    createTextControl: function (a, b, c) {
        ...
        jQuery('<input type="text">').attr("id", g).attr("name", g).addClass(f).addClass(d).addClass('txt input-text').addClass(c ? "mytheme-focus-here" : "").appendTo(b);
    ...
    makeShortcode: function () {
		...
		case 'text-wrapper':
        		...
        		var shortcode = "[" + frameworkShortcodeAtts.shortcode + f + "]" + "[/" + frameworkShortcodeAtts.shortcode + "]"
