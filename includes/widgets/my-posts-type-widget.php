...
function widget($args, $instance) {
  ...
  $cat_posts = new WP_Query(
    ...
    <?php if ($instance['posttype'] == "testi") {
	 ...
	 $testiaddress = $custom["testimonial-address"][0];
		...
		<li class="cat_post_item-<?php echo $posts_counter; ?> clearfix">
			...
			<?php if ($instance['posttype'] == "testi") { ?>
              <div class="name-testi"><span class="user"><?php echo $testiname; ?></span><?php if ($testitype!="") echo ', '; ?><span class="type"><?php echo $testitype; ?></span><?php if ($testiaddress!="") echo ', '; ?> <?php echo $testiaddress; ?></div>
            <?php }?>
	...
	<?php if ( $instance['global_link'] ) : ?>
	  <a href="<?php echo $instance['global_link_href']; ?>" class="link_show_all button"><span class="right"><?php if($instance['global_link_text']==""){ ?>View all<?php }else{ ?><?php echo $instance['global_link_text']; ?><?php } ?></span></a>
	<?php endif; ?>
